...
// this is kind of local storage where we can store the data
let array = JSON.parse(localStorage.getItem("praveen"))||[];

// this is dom method to catching target 
 document.querySelector("#sum").innerHTML=`wallet-: ${array}`;
